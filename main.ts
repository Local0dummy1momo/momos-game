...
namespace SpriteKind {
    ...
    export const narrarator = SpriteKind.create()
...
controller.combos.attachCombo("downdownupuprightleftrightleftab", function () {
...
controller.combos.attachCombo("upupdowndownleftrightleftrightba", function () {
    game.splash("hahaha didn't know you knew the konami code!", "nice...")
    game.splash("do downdownupuprightleftrightleftab")
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    if (controller.A.isPressed()) {
        mysprite3.destroy(effects.spray, 1000)
    }
})
